...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN ='2062966587:AAFh6PIRdEtSyJwDb7mgv_URQTOA2N1eAZ0'# Get it from https://t.me/BotFather
    APP_ID ='11593524' # Get it from my.telegram.org/apps
    API_HASH ='7f4cf678b78625a2dcf40d2be97f5127'# Get it from my.telegram.org/apps
...
class Messages:
    ...
    HELP_MSG = [
        ...
        ] # SQL Database URL / Heroku Postgres URL
